...
func TestProperty13_ResetCreditsAccuracy(t *testing.T) {
	...
	f := func(seed int64) bool {
		...
		// Reset
		if err2 := m.ResetCredits("prop13_pool"); err2 != nil {
			return false
		}
...
func TestResetCredits_Success(t *testing.T) {
	...
	// Reset
	if err2 := m.ResetCredits("pool1"); err2 != nil {
...
func TestAddCredits_Success(t *testing.T) {
	...
	// Add credits
	if err2 := m.AddCredits("pool1", MustNewCredit("5")); err2 != nil {
		t.Fatalf("unexpected error: %v", err2)
	}
...
func TestSetCredits_Success(t *testing.T) {
	...
	if err2 := m.SetCredits("pool1", MustNewCredit("42")); err2 != nil {
		t.Fatalf("unexpected error: %v", err2)
	}
